(function () {
    ...
    */
    console.log( '\nOperation:' );
    var operation = justMod2Or3.reduce(function ( aggregate, current ) {
            return (aggregate + 1) * current;
    ...
    */
    console.log( '\nOperation 2:' );
    var operation2 = justMod2Or3.reduceRight(function ( aggregate, current ) {
            return (aggregate + 1) * current;
