...
*/
var pessoa = { nome: 'Xico', sobrenome: 'Parreira', sexo: 'Masculino', idade: 27, altura: 1.80, peso: 90, andando: false, caminhouQuantosMetros: 0 }
...
pessoa.mostrarAltura = function () {
    return 'A minha altura é ' + pessoa.altura + ' m.'
}
...
*/
pessoa.nomeCompleto() //'Olá o meu nome é Xico Parreira!'
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarAltura() // 'A minha altura é 1.8 m.'
...
*/
pessoa.caminhouQuantosMetros // 63
