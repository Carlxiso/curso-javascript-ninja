(function () {
    ...
    */
    ...
    var arrCpf = ['049-214 3421-1', '210.458.522-05', '735 500 794 - 22', '101.123-131x32' ];
    ...
    */
    ...
    var text = 'junho julho';
    var regex = /(\w{5})/g;
    console.log("Os meses de janeiro, junho e julho começam com a letra j.", text.match(regex));
    ...
    */
    ...
    var tagMatch = /<\w+>/g;
    console.log(tags.match(tagMatch));
