(function () {
    ...
    */
    ...
    console.log(text);
    console.log(text.replace(/Manuel Marques de Sousa/, 'Abino Zé'));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'lisboeta') );
    ...
    */
    ...
    console.log(text.replace(/de junho de|de julho de/g, '/ /'));
