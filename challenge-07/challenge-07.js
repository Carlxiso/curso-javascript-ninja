...
*/
console.log("O segundo elemento do segundo array é " + crazyTypes[6][1]  + ".");
...
*/
console.log("O segundo array tem " + crazyTypes[6].length  + " itens.");
